      ...
      <div class="filter-container">
        <el-form ref="filterForm" :inline="true" :model="filterForm">
          <btns @dataInit="init(1, 'pageNum')" @resetForm="resetForm('filterForm')">
            <template slot="top">
              <el-button size="samll" type="primary" @click.stop="showLayer({ component: 'add', title: '商品分类', type: 'add' })">
                新增分类
              </el-button>
            </template>
...
<script>
import { getGoodsClass, classificationLists, delClassification } from '@/api/goods.js'
